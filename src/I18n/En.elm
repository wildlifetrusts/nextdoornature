...
enStrings key =
    case key of
        ...
        ---
        WelcomeP1 ->
            "[cCc] NextDoorNature is an initiative launched by the Wilidlife Trusts in 2022. (Read more here) The aim of NextDoorNature is to equip everyone with the skills and knowledge they need to make a positive difference for nature - in their own area, and beyond."
        ...
        WelcomeP3 ->
            "[cCc] The goal of NextDoorNature is to get at least 1 in 4 people across the UK taking Action for Nature. This online library aims to support anyone who is interested in finding out what they can do, and how they can get other people involved."
